...
async function bruteForceSearch(listDateStr) {
...
if (!companyName || !listingDateStr) {
    console.error("Usage: node find-bse-notice.js <companyName> <listingDateStr>");
    process.exit(1);
}

bruteForceSearch(listingDateStr);
